...
urlpatterns = patterns('',
    ...
    url(r'^profile/edit/location/done/$', TemplateView,
    ...
    url(r'^profile/edit/personal/done/$',TemplateView,
    ...
    url(r'^profile/delete/done/$', TemplateView,
    ...
    url(r'^profile/edit/avatar/crop/done/$', TemplateView,
    ...
    url(r'^email/validation/processed/$', TemplateView,
