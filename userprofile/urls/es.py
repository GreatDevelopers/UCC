...
urlpatterns = patterns('',
    ...
    url(r'^perfil/editar/ubicacion/listo/$', TemplateView,
    ...
    url(r'^perfil/editar/personal/listo/$', TemplateView,
    ...
    url(r'^perfil/eliminar/listo/$', TemplateView,
    ...
    url(r'^perfil/edit/avatar/recortar/listo/$', TemplateView,
    ...
    url(r'^email/validar/procesado/$', TemplateView,
    ...
    url(r'^registro/validar/$', TemplateView,
        {'template' : 'userprofile/account/validate.html'},
        name='signup_validate'),

    url(r'^registro/completo/$', TemplateView,
